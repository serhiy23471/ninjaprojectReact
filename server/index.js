...
// Імпорт роутів
const searchUserRouter = require('./routes/admin/searchUser');
const banRouter = require('./routes/admin/ban');       // якщо є
const muteRouter = require('./routes/admin/mute');     // якщо є
const vipRouter = require('./routes/admin/vip');       // якщо є
...
// Підключення роутів з префіксом, наприклад /api/admin
app.use('/api/admin', searchUserRouter);
app.use('/api/admin', banRouter);
app.use('/api/admin', muteRouter);
app.use('/api/admin', vipRouter);
// API routes
