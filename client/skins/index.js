...
if (config.HOST == 'localhost' || config.HOST == '127.0.0.1') {
    ...
    Logger.core.trace(`'https://ninjaproject.com.ua' at config detected, *returnURL* and *realm* changed to have port in it`)
}
...
const server = app.listen(port, config.INTERNAL_HOST, () => {
    startup()
    Logger.core.info(`App listening at ${config.PROTOCOL}:https://ninjaproject.com.ua:${port}`)
});
